...
public class RetiroStepDefinitions {
    ...
    @Entonces("la transacci\u00f3n de retiro es exitosa con c\u00f3digo {string}")
    public void laTransaccionRetiroEsExitosa(String codigoEsperado) {
        assertThat(
    ...
    @Entonces("la severidad del retiro es {string}")
    public void laSeveridadDelRetiroEs(String severidadEsperada) {
        assertThat(
    ...
    @Entonces("la descripci\u00f3n del retiro es {string}")
    public void laDescripcionDelRetiroEs(String descripcionEsperada) {
        assertThat(
